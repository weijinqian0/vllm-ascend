...
from typing import Callable, Optional, overload, List
...
from vllm_ascend.ops.moe.moe_dispatcher import MoEAllToAllTokenDispatcher, MoeDispatcherConfig
...
class AscendUnquantizedFusedMoEMethod(UnquantizedFusedMoEMethod):
    ...
    def apply(
        ...
        if VLLM_ENABLE_MC2 and not is_prefill:
            ...
            moe_dispatcher = kwargs['moe_dispatcher']
            return moe_dispatcher.forward(hidden_states=x,
                                              w1=layer.w13_weight,
                                              w2=layer.w2_weight,
                                              topk_weights=topk_weights,
                                              topk_ids=topk_ids,
...
class AscendFusedMoE(FusedMoE):
    ...
    def forward(self,
        ...
        final_hidden_states = self.quant_method.apply(
            ...
            moe_dispatcher=self.moe_dispatcher)
